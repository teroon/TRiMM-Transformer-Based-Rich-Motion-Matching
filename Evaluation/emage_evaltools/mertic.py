...
class FGD(object):
    def __init__(self, download_path="./emage_evaltools/", device="cuda"):
        if download_path is not None:
            os.makedirs(download_path, exist_ok=True)
            ...
            if not os.path.exists(model_file_path):
                print(f"Downloading {model_file_path}")
                wget.download(
                    "https://hf-mirror.com/spaces/H-Liu1997/EMAGE/resolve/main/EMAGE/test_sequences/weights/AESKConv_240_100.bin",
                    model_file_path,
                )
            ...
            if not os.path.exists(smplx_model_file_path):
                ...
                wget.download(
                    "https://hf-mirror.com/spaces/H-Liu1997/EMAGE/resolve/main/EMAGE/smplx_models/smplx/SMPLX_NEUTRAL_2020.npz",
